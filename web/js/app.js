...
let FACULTY_DATA = {
  "School of computing": {
    ...
    departments: {
      "Computer Science": {
        ...
        hodRoom: "D-101 D",
        teachers: [
          { name: "Dr. Muhammad Arshad Islam", designation: "Professor & HoD", email: "arshad.islam@nu.edu.pk", room: "D-101 D" },
          { name: "Dr. Aftab Maroof", designation: "Professor & Rector NUCES", email: "aftab.maroof@nu.edu.pk", room: "A-114 A" },
          { name: "Dr. Kashif Munir", designation: "Professor", email: "kashif.munir@nu.edu.pk", room: "D-109 E" },
          ...
          { name: "Dr. Akhtar Jamil", designation: "Associate Professor & Coordinator GSC", email: "akhtar.jamil@nu.edu.pk", room: "D-113 C" },
          ...
          { name: "Dr. Amna Basharat", designation: "Associate Professor", email: "amna.basharat@nu.edu.pk", room: "D-205 D" },
          ...
          { name: "Mr. Shams Farooq", designation: "Lecturer", email: "shams.farooq@nu.edu.pk", room: "C-204 D" },
          { name: "Mr. Shehreyar Rashid", designation: "Lecturer", email: "shehreyar.rashid@nu.edu.pk", room: "C-205 D" },
          ...
          { name: "Ms. Sana Razzaq", designation: "Lecturer", email: "sana.razzaq@nu.edu.pk", room: "C-502 D" },
          ...
          { name: "Ms. Seerat Afreen Satti", designation: "Instructor", email: "seerat.afreen@isb.nu.edu.pk", room: "D-202 H" },
          { name: "Ms. Maryam Khalid", designation: "Instructor", email: "maryam.khalid@isb.nu.edu.pk", room: "D-110 A" },
          { name: "Ms. Mavra Mehak Gill", designation: "Instructor", email: "mavra.mehak@isb.nu.edu.pk", room: "D-104" },
          { name: "Ms. Haqeeq Ruman", designation: "Instructor", email: "haqeeq.ruman@isb.nu.edu.pk", room: "D-104" },
          { name: "Ms. Gul E Zahra", designation: "Instructor", email: "gul.zahra@isb.nu.edu.pk", room: "D-104" }
        ]
      },
      "Artificial Intelligence & Data Science": {
        ...
        hodRoom: "D-201 C",
        teachers: [
          { name: "Dr. Ahmad Din", designation: "Professor & HoD", email: "ahmad.din@nu.edu.pk", room: "D-201 C" },
          ...
          { name: "Dr. Mateen Yaqoob", designation: "Associate Professor", email: "mateen.yaqoob@isb.nu.edu.pk", room: "D-212 D" },
          ...
          { name: "Dr. Usama Imtiaz", designation: "Assistant Professor", email: "Usama.Imtiaz@isb.nu.edu.pk", room: "D-112 E" },
          ...
          { name: "Ms. Mehreen Javaid", designation: "Lecturer", email: "mehreen.javaid@nu.edu.pk", room: "D-205 H" },
          { name: "Mr. Abdul Hammad Rasheed", designation: "Instructor", email: "hammad.rasheed@isb.nu.edu.pk", room: "D-111 C" },
          { name: "Mr. Abdul Wahab Khan", designation: "Instructor", email: "abdul.wahab@isb.nu.edu.pk", room: "C-504 E" },
          { name: "Mr. Ali Hamza", designation: "Instructor", email: "ali.hamza@isb.nu.edu.pk", room: "C-504 E" },
          { name: "Ms. Mubrra Asma", designation: "Instructor", email: "mubrra.asma@isb.nu.edu.pk", room: "C-513 C" },
          { name: "Ms. Nabeelah Maryam", designation: "Instructor", email: "nabeelah.maryam@isb.nu.edu.pk", room: "C-108 A" },
      ...
      "Software Engineering": {
        ...
        hodEmail: "atif.jilani@nu.edu.pk",
        hodRoom: "C-502 C",
        teachers: [
          { name: "Dr. Atif Aftab Ahmed Jilani", designation: "Associate Professor & HoD", email: "atif.jilani@nu.edu.pk", room: "C-502 C" },
          { name: "Dr. Usman Habib", designation: "Professor", email: "usman.habib@nu.edu.pk", room: "C-501 C" },
          { name: "Dr. Naveed Ahmad", designation: "Professor (Adjunct)", email: "naveed.ahmad@nu.edu.pk", room: "C-204 C" },
          { name: "Dr. Asif Muhammad", designation: "Associate Professor", email: "asif.muhammad@isb.nu.edu.pk", room: "C-503 E" },
          { name: "Dr. Muhammad Bilal", designation: "Associate Professor", email: "muhammad.bilal@isb.nu.edu.pk", room: "C-502 E" },
          ...
          { name: "Dr. Uzma Mahar", designation: "Assistant Professor", email: "uzma.mahar@nu.edu.pk", room: "C-503 A" },
          { name: "Dr. Nigar Azhar Butt", designation: "Assistant Professor", email: "nigar.azhar@isb.nu.edu.pk", room: "C-503 C" },
      ...
      "Cyber Security": {
        ...
        hodRoom: "D-208 A",
        teachers: [
          { name: "Dr. Qaisar Shafi", designation: "Assistant Professor & HoD", email: "qaisar.shafi@nu.edu.pk", room: "D-208 A" },
          ...
          { name: "Dr. Jawad Hassan Nisar", designation: "Assistant Professor", email: "jawad.hassan@nu.edu.pk", room: "D-204 D" },
          { name: "Dr. Hina Binte Haq", designation: "Assistant Professor", email: "hina.haq@nu.edu.pk", room: "D-205 F" },
          ...
          { name: "Ms. Naveen Khan", designation: "Lecturer", email: "naveen.khan@isb.nu.edu.pk", room: "C-202 D" },
          { name: "Ms. Sadia Saad", designation: "Lecturer", email: "sadia.saad@nu.edu.pk", room: "D-205 G" },
          { name: "Mr. Ahsan Shakeel Malik", designation: "Instructor", email: "ahsan.shakeel@isb.nu.edu.pk", room: "C-204 B" },
          ...
          { name: "Ms. Areej Fatima", designation: "Instructor", email: "areej.fatima@isb.nu.edu.pk", room: "D-205 A" },
  ...
  "Sciences and Humanities": {
    hosName: "Muhammad Tayyeb Nadeem",
    hosDesignation: "Professor & Head, S&H",
    hosEmail: "tayyeb.nadeem@nu.edu.pk",
    hosRoom: "B-101 A",
    departments: {
      "Science And Humanities": {
        hodName: "Muhammad Tayyeb Nadeem",
        hodDesignation: "Professor & Head, S&H",
        hodEmail: "tayyeb.nadeem@nu.edu.pk",
        hodRoom: "B-101 A",
        teachers: [
          { name: "Aisha", designation: "Assistant Professor", email: "aisha.ijaz@nu.edu.pk", room: "" },
          { name: "Maria Mazhar", designation: "Lecturer", email: "maria.mazhar@isb.nu.edu.pk", room: "" },
          { name: "Aqsa Malik", designation: "Lecturer", email: "aqsa.malik@nu.edu.pk", room: "" },
          { name: "Arisha Wasim", designation: "Instructor", email: "arisha.wassim@nu.edu.pk", room: "" },
          { name: "Abdul Basit", designation: "Instructor", email: "abdul.basit@isb.nu.edu.pk", room: "" },
          { name: "Eeman Mirza", designation: "Lecturer", email: "eeman.mirza@nu.edu.pk", room: "" },
          { name: "Farah Jabeen", designation: "Assistant Professor", email: "farah.awan@nu.edu.pk", room: "" },
          { name: "Ghalia", designation: "Instructor", email: "ghalia.gohar@nu.edu.pk", room: "" },
          { name: "Hajra Khalid", designation: "Lecturer", email: "hajra.khalid@nu.edu.pk", room: "" },
          { name: "Halla Waheed", designation: "Instructor", email: "halla.waheed@nu.edu.pk", room: "" },
          { name: "Hamda khan", designation: "Associate Professor", email: "hamda.khan@nu.edu.pk", room: "" },
          { name: "Hasham Ahmad", designation: "Lecturer", email: "hasham.ahmad@nu.edu.pk", room: "" },
          { name: "Hazber", designation: "Lecturer", email: "hazber.samson@isb.nu.edu.pk", room: "" },
          { name: "Hafiz Muhammad Hammad", designation: "Lecturer", email: "hafiz.hammad@isb.nu.edu.pk", room: "" },
          { name: "Khadija Farooq", designation: "Assistant Professor", email: "khadija.farooq@nu.edu.pk", room: "" },
          { name: "Khalil Ullah", designation: "Assistant Professor", email: "khalil.awan@nu.edu.pk", room: "" },
          { name: "Maryam Abid", designation: "Lecturer", email: "maryam.abid@nu.edu.pk", room: "" },
          { name: "Mehreen", designation: "Lecturer", email: "mehreen@nu.edu.pk", room: "" },
          { name: "Mehwish Hassan", designation: "Assistant Professor", email: "mehwish.hassan@nu.edu.pk", room: "" },
          { name: "Memoona Rasool", designation: "Assistant Professor", email: "maimoona.rasool@nu.edu.pk", room: "" },
          { name: "Momal Saleem", designation: "Instructor", email: "momal.saleem@nu.edu.pk", room: "" },
          { name: "Muhammad Ali", designation: "Associate Professor", email: "m.ali@nu.edu.pk", room: "" },
          { name: "Muhammad Ajmal", designation: "Lecturer", email: "muhammad.ajmal@nu.edu.pk", room: "" },
          { name: "Muhammad Ibrahim", designation: "Lecturer", email: "m.ibraheem@nu.edu.pk", room: "" },
          { name: "Muhammad Tayyeb Nadeem", designation: "Professor", email: "tayyeb.nadeem@nu.edu.pk", room: "" },
          { name: "Muhammad Usman Ashraf", designation: "Professor", email: "usman.ashraf@nu.edu.pk", room: "" },
          { name: "Muhammad Usman Rashid", designation: "Lecturer", email: "usman.rashid@nu.edu.pk", room: "" },
          { name: "Rabia Islam", designation: "Lecturer", email: "rabia.islam@isb.nu.edu.pk", room: "" },
          { name: "Lubna", designation: "Lecturer", email: "lubna@nu.edu.pk", room: "" },
          { name: "Sadia Nauman", designation: "Lecturer", email: "sadia.nauman@nu.edu.pk", room: "" },
          { name: "Sara Aziz", designation: "Assistant Professor", email: "sara.aziz@nu.edu.pk", room: "" },
          { name: "Sana Ilyas", designation: "Lecturer", email: "sanaa.ilyas@nu.edu.pk", room: "" },
          { name: "Sehrish Hassan", designation: "Assistant Professor", email: "sehrish.hassan@nu.edu.pk", room: "" },
          { name: "Shahzad Mahmood", designation: "Assistant Professor", email: "shahzad.mahmood@nu.edu.pk", room: "" },
          { name: "Sumera Abbas", designation: "Lecturer", email: "sumera.abbas@nu.edu.pk", room: "" },
          { name: "Sumaira Azhar", designation: "Assistant Professor", email: "sumaira.azhar@nu.edu.pk", room: "" },
          { name: "Sumayyah Malik", designation: "Lecturer", email: "sumayyah.malik@nu.edu.pk", room: "" },
          { name: "Syed Irfan Shah", designation: "Professor", email: "irfan.shah@nu.edu.pk", room: "" },
          { name: "Tayyaba Waseem", designation: "Lecturer", email: "tayyaba.waseem@isb.nu.edu.pk", room: "" },
          { name: "Zirwa", designation: "Instructor", email: "zirva.shabbir@isb.nu.edu.pk", room: "" },
          { name: "Ms. Iqra Fatima", designation: "Instructor", email: "iqra.fatima@isb.nu.edu.pk", room: "" },
          { name: "Ms. Sadia Sahar", designation: "Instructor", email: "sadia.sahar@isb.nu.edu.pk", room: "" },
          { name: "Faisal ur rahman", designation: "Lecturer", email: "faisal.rehman@isb.nu.edu.pk", room: "" },
          { name: "Muhammad Saqib", designation: "Lecturer", email: "muhammad.saqib@isb.nu.edu.pk", room: "" },
          { name: "Muhammad Umer", designation: "Instructor", email: "muhammad.umer@isb.nu.edu.pk", room: "" },
          { name: "Shan e Batool", designation: "Instructor", email: "shan.batool@isb.nu.edu.pk", room: "" },
          { name: "Sayeda Hassan", designation: "Instructor", email: "sayeda.hassan@isb.nu.edu.pk", room: "" },
          { name: "Sayeda Mahnoor Ali", designation: "Instructor", email: "mahnoor.ali@isb.nu.edu.pk", room: "" },
          { name: "Tehmina ijaz", designation: "Lecturer", email: "tehmina.ejaz@isb.nu.edu.pk", room: "" },
          { name: "Aseefa Zareen", designation: "Lecturer", email: "asefa.zareen@isb.nu.edu.pk", room: "" },
          { name: "Rao M. Touqeer", designation: "Lecturer", email: "muhammad.touqeer@isb.nu.edu.pk", room: "" },
          { name: "Waqar Ahmad", designation: "Lecturer", email: "waqar.ahmad@isb.nu.edu.pk", room: "" }
        ]
      }
    }
  }
...
(function bg(){
  ...
  function draw(){
    ...
    const bgFill=dark?'#0d1912':'#f0f7f0';
    const lineRGB=dark?'120,220,160':'0,140,70';
    ...
    for(let i=0;i<=10;i++){
      ...
      for(let d=0;d<2;d++){
        ...
        ctx.strokeStyle=`rgba(${lineRGB},${0.065*(1-Math.abs(x-.5)*1.4)})`;ctx.lineWidth=.7;
        ...
        for(let j=0;j<=10;j++){const y=j/10;ctx.strokeStyle=`rgba(${lineRGB},0.05)`;ctx.beginPath();ctx.moveTo((0-.5)*pers/(z0*fov)+W/2,(y-.5)*pers/(z0*fov)+H/2);ctx.lineTo((1-.5)*pers/(z0*fov)+W/2,(y-.5)*pers/(z0*fov)+H/2);ctx.stroke();}
      }
    }
    pts.forEach(p=>{
      p.x+=p.vx;p.y+=p.vy;
      if(p.x<0||p.x>1)p.vx*=-1;if(p.y<0||p.y>1)p.vy*=-1;
      ctx.beginPath();ctx.arc(p.x*W,p.y*H,1.4,0,Math.PI*2);ctx.fillStyle=`rgba(${lineRGB},0.15)`;ctx.fill();
    });
    pts.forEach((a,i)=>pts.slice(i+1).forEach(b=>{
      const dx=(a.x-b.x)*W,dy=(a.y-b.y)*H,dist=Math.sqrt(dx*dx+dy*dy);
      if(dist<72){ctx.beginPath();ctx.moveTo(a.x*W,a.y*H);ctx.lineTo(b.x*W,b.y*H);ctx.strokeStyle=`rgba(${lineRGB},${0.07*(1-dist/72)})`;ctx.lineWidth=.5;ctx.stroke();}
    }));
